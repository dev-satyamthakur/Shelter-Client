        ...
        <div className="p-8 grid gap-4">
          <div>
            ...
            <button
              ...
              className="fixed right-12 top-8 flex gap-1 py-2 px-4 rounded-2xl bg-gray-300 text-black shadow shadow-gray-700"
            >
              <svg
    ...
    <div className="mt-4 bg-gray-100 -mx-8 px-8 pt-6">
      ...
      <div className="bg-white -mx-8 px-8 py-8 border-t">
        <div>
          ...
          <div className="text-gray-700 leading-5 mb-4 mt-2">
            {place.extraInfo}
          </div>
        </div>
      </div>
